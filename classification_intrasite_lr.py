...
def classification_metrics_vis_v1(nperm,data1,data2,data3,labels,step_min,step_max,step):
    """
     ...
     kbest as feature selection method for three datasets.
    ---
    Params:
    ...
    lr= LogisticRegression(penalty='l2', random_state=0,solver='lbfgs',max_iter=1000)
   ...
   ## pvalue between data1 and data2 
    ...
    for i in tqdm.tqdm(range(step_min,step_max,step)):
        ...
        pipe_clf= make_pipeline(StandardScaler(),SelectKBest(k=i), lr)
...
np.savez_compressed("all_site_"+"intra"+"filtering_GlobalSR_k10_QC_lr_std+SG_STD_FC.npz",
                        labels=LABELS_ALL,
...
np.savez_compressed("all_site_"+"intra"+"filtering_GlobalSR_k10_QC_lr_std+SG_Mean_Mean+SG.npz",
                        labels=LABELS_ALL,
...
np.savez_compressed("all_site_"+"intra"+"filtering_GlobalSR_k10_QC_lr_std+SG_EC_NS.npz",
                        labels=LABELS_ALL,
                        eig_cens=eig_cens,
...
np.savez_compressed("all_site_"+"intra"+"filtering_GlobalSR_k10_QC_lr_std+SG_CC_var.npz",
                        labels=LABELS_ALL,
...
np.savez_compressed("all_site_"+"intra"+"filtering_GlobalSR_k10_QC_lr_std+SG_kurtosis_kurtosis+SG.npz",
                        labels=LABELS_ALL,
                        abide_ts_std=abide_ts_std,
...
np.savez_compressed("all_site_"+"intra"+"filtering_GlobalSR_k10_QC_lr_std+SG_var_var+SG.npz",
                        labels=LABELS_ALL,
                        abide_ts_std=abide_ts_std,
                        abide_ts_var=abide_ts_var,
                        signals_fourier_std=signals_fourier_std,
