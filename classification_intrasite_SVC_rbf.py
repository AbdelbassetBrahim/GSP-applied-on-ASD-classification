...
np.savez_compressed("all_site_"+"intra"+"filtering_GlobalSR_k20_QC_svc_std+SG_STD_FC_rbf.npz",
                        labels=LABELS_ALL,
...
np.savez_compressed("all_site_"+"intra"+"filtering_GlobalSR_k20_QC_svc_std+SG_Mean_Mean+SG_rbf.npz",
                        labels=LABELS_ALL,
...
np.savez_compressed("all_site_"+"intra"+"filtering_GlobalSR_k20_QC_svc_std+SG_EC_NS_rbf.npz",
                        labels=LABELS_ALL,
                        eig_cens=eig_cens,
...
np.savez_compressed("all_site_"+"intra"+"filtering_GlobalSR_k20_QC_svc_std+SG_CC_var_rbf.npz",
                        labels=LABELS_ALL,
...
np.savez_compressed("all_site_"+"intra"+"filtering_GlobalSR_k20_QC_svc_std+SG_kurtosis_kurtosis+SG_rbf.npz",
                        labels=LABELS_ALL,
                        abide_ts_std=abide_ts_std,
...
np.savez_compressed("all_site_"+"intra"+"filtering_GlobalSR_k20_QC_svc_std+SG_var_var+SG_rbf.npz",
                        labels=LABELS_ALL,
                        abide_ts_std=abide_ts_std,
                        abide_ts_var=abide_ts_var,
                        signals_fourier_std=signals_fourier_std,
